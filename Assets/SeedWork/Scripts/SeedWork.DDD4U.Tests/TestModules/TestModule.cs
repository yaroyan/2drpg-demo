...
namespace Yaroyan.SeedWork.DDD4U.Test
{
    ...
    [Serializable]
    public sealed record TestRegisteredEvent(string Id, long Sequence, DateTime OccurredOn, string Name) : Event(Id, Sequence, OccurredOn), ITestEvent;
    [Serializable]
    public sealed record TestChangeNameEvent(string Id, long Sequence, DateTime OccurredOn, string Name) : Event(Id, Sequence, OccurredOn), ITestEvent;
    [Serializable]
