...
namespace Yaroyan.SproutWork
{
    public class Gateway : MonoBehaviour
    {
        ...
        {
            if (SceneManager.GetActiveScene().name == _arrival.Scene.SceneContext.SceneName)
            {
                Warp(other);
            }
            else
        ...
        void LoadScene()
        {
            ...
            SceneManager.LoadScene(_arrival.Scene.SceneContext.SceneName);
        }
